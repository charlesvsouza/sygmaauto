  ...
  const navItemClass = (to: string) => {
    ...
    return [
      ...
      isActive
        ...
        : 'text-[#d1d9e2] hover:text-white hover:bg-white/8',
    ].join(' ');
  };
    ...
    >
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled ? 'bg-[#07101a]/88 backdrop-blur-md border-b border-white/10 shadow-[0_10px_36px_rgba(0,0,0,0.45)]' : 'bg-transparent'
        }`}
      >
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="md:hidden w-9 h-9 rounded-xl border border-white/15 flex items-center justify-center text-[#d1d9e2] hover:text-white transition-colors"
              aria-label="Menu"
            >
        ...
        <AnimatePresence>
          {menuOpen && (
            <motion.div
              ...
              className="md:hidden border-t border-white/10 bg-[#07101a]/95 backdrop-blur-md overflow-hidden"
            >
          ...
          <div className="flex items-center gap-3">
            {[
              ...
              <a
                ...
                aria-label={label}
                className="w-9 h-9 rounded-xl border border-white/15 bg-white/5 flex items-center justify-center text-[#9aa9ba] hover:text-[#8ce2e7] hover:border-[#0b7f86]/55 hover:bg-[#0b7f86]/16 transition-all"
              >
                <Icon size={16} />
              </a>
            ))}
