              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input value={tenantName} onChange={(e) => setTenantName(e.target.value)} required className="w-full bg-surface-950/60 border border-line rounded-xl py-3 pl-10 pr-4 text-white text-sm outline-none focus:ring-2 focus:ring-blue-500/40" placeholder="Oficina Exemplo" />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input type="email" value={inviteEmail} onChange={(e) => setInviteEmail(e.target.value)} required className="w-full bg-surface-950/60 border border-line rounded-xl py-3 pl-10 pr-4 text-white text-sm outline-none focus:ring-2 focus:ring-blue-500/40" placeholder="cliente@email.com" />
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <select value={planName} onChange={(e) => setPlanName(e.target.value)} disabled={loadingPlans} className="w-full bg-surface-950/60 border border-line rounded-xl py-3 pl-10 pr-4 text-white text-sm outline-none focus:ring-2 focus:ring-blue-500/40">
                ...
                <div className="space-y-2">
                  ...
                  <input value={document} onChange={(e) => setDocument(e.target.value)} className="w-full bg-surface-950/60 border border-line rounded-xl py-3 px-4 text-white text-sm outline-none focus:ring-2 focus:ring-blue-500/40" placeholder="Opcional" />
                </div>
              </div>

              <div className="flex justify-end gap-3 pt-2">
                <button type="button" onClick={onClose} className="px-4 py-3 bg-ink/5 hover:bg-ink/5 text-white rounded-xl font-bold text-sm">Cancelar</button>
